#!/usr/bin/env bash
# M3 full redeploy: veil_core (with VkId::Swap/BatchSettle) + amm_pool
# Uses the existing SECRET/ADMIN/ASP from deployments/testnet.env
#
# Usage: source deployments/testnet.env && bash deployments/m3-deploy.sh
...
# Generated by m3-deploy.sh at $(date -u)
VEIL_CORE=$VEIL_CORE
ASP=$ASP
AMM_POOL=$AMM_POOL
ADMIN=$ADMIN
...
echo ""
echo "Run e2e test:"
echo "  source deployments/testnet.env && node e2e-tests/src/amm-spike.test.js"
